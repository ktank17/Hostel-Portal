...
<body>
	<div class="container">
		...
		<div class="icon">
				...
				<div class="link">
					<div class="btn">
						<form action="admin_filter_male.php" method="POST">
						<center><table>
								<tr>
								<td><button type="submit" name="male" class="w3-btn w3-white w3-border w3-border-black w3-round-large">List Of Male</button></td>
						</tr>
						</table>
						</center>
						</form>
						<form action="admin_filter_female.php" method="POST">
							<center><table>
								<tr>

								<td><button type="submit" name="female" class="w3-btn w3-white w3-border w3-border-black w3-round-large">List Of Female</button></td>
								</tr>
							</table></center>
						</form>
					</div>
