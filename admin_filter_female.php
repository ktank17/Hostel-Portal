...
<body>
	<div class="container">
		...
		<div class="icon">
				...
				<div class="link">
					<div class="btn">
						<form action="after_admin_filter_female.php" method="POST">
						<center><table>
								<tr>
								<td><button type="submit" name="gen_female" class="w3-btn w3-white w3-border w3-border-black w3-round-large">General</button></td>
								<td><button type="submit" name="obc_female" class="w3-btn w3-white w3-border w3-border-black w3-round-large">OBC</button></td>
								<td><button type="submit" name="sc_female" class="w3-btn w3-white w3-border w3-border-black w3-round-large">SC</button></td>
								<td><button type="submit" name="all_female" class="w3-btn w3-white w3-border w3-border-black w3-round-large">All</button></td>
