				...
				<div class="link">
					...
					<div class="btn">
						...
						<form action="after_admin_remove.php" method="POST">
							Enter Contact:
							<input type="text" name="contact_remove_text">
							<button type="submit" name="contact" class="w3-btn w3-white w3-border w3-border-black w3-round-large">Remove</button></td>
						</form>
					</div></center>
				</div>
		</div>
