		...
		<div class="icon">
				...
				<div class="link">
					...
					<div class="btn">
						...
						<form action="admin_remove_email.php" method="POST">
							<button type="submit" name="admin_email_remove" class="w3-btn w3-white w3-border w3-border-black w3-round-large">By Email</button></td>
						</form>
						<form action="admin_remove_contact.php" method="POST">
							<button type="submit" name="admin_contact" class="w3-btn w3-white w3-border w3-border-black w3-round-large">By Contact Detail</button></td>	
						</form>
					</div></center>
				</div>
		</div>
